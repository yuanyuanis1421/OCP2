...
public class HtmlToTextTest {
	 private static final String userAgent = "Mozilla/5.0 (jsoup)";
	    ...
	    public static void main(String... args) throws IOException {
	        ...
	        Document doc = Jsoup.connect(PATH).userAgent(userAgent).timeout(timeout).get();

	        HtmlToTextTest formatter = new HtmlToTextTest();
	    ...
	    private class FormattingVisitor implements NodeVisitor {
	        ...
	        public void head(Node node, int depth) {
	            ...
	            if(node instanceof Element){
	            	...
	            	if(e.tagName().equals("tr")&&e.hasClass("odd")
	            			&&e.parentNode().parentNode() instanceof Element
	            			&&((Element)e.parentNode().parentNode()).tagName().equals("table")
